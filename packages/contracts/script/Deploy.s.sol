...
/// @notice Deploys FhoxFactory pointed at Fhenix Nitrogen's canonical USDC + ERC-8004
///         IdentityRegistry. Run with:
///         forge script script/Deploy.s.sol:Deploy --rpc-url $FHENIX_RPC_URL --broadcast
contract Deploy is Script {
    // Fhenix Nitrogen canonical addresses
    ...
    function run() external returns (FhoxFactory factory) {
        ...
        factory = new FhoxFactory(IERC20(ARC_USDC), IIdentityRegistry(ARC_IDENTITY_REGISTRY));
        vm.stopBroadcast();
